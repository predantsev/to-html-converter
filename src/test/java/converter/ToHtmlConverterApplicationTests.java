...
@SpringApplicationConfiguration(classes = ToHtmlConverterApplication.class)
@WebAppConfiguration
@IntegrationTest("server.port=0")
public class ToHtmlConverterApplicationTests {
	...
	public void tokenKeyEndpointWithSecret() {
		assertEquals(
				HttpStatus.OK,
				new TestRestTemplate(securityProperties.getUser().getName(), securityProperties.getUser().getPassword()).getForEntity(
